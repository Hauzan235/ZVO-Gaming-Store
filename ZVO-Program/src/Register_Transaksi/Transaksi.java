...
public class Transaksi {
    public void show() {
        ...
        //Array
        String[] jenis = {"PUBG", "COD", "Free Fire", "Mobile Legends", "Genshin Impact"};
        System.out.print("Masukkan Pilihan Angka dari 1- ");
        System.out.println(jenis.length);

        pilihan = in.nextInt();

            do {

                //input jenis voucher yang akan dibeli
                ...
                switch (pilihan) {
                    ...
                    case 5:
                        ...
                        System.out.println("Harga sudah termasuk 10% PPN");
                        System.out.print("Masukkan Nominal Topup / Jumlah Genesis Crystals = ");
                        jumlah = in.nextInt();
                        harga = 5000 * jumlah;
                        System.out.println("Harga = Rp. " + harga);
                        jumlah2 = jumlah;
                        ...
                        System.out.println("Jumlah Genesis Crystals yang didapat = " + jumlah2);
                        System.out.println("Selamat Anda cukup membayar Rp. " + harga + " untuk " + jumlah2 + " Genesis Crystals");
